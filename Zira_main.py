...
for i in range(3):
    a = input("Enter Password to open zira :- ")
            ...
            while True:
                ...
                if "go to sleep" in query:
                    ...
                    if (a==1):
                        ...
                        os.startfile("D:\\Zira_Final\\FocusMode.py")
                        exit()
                    ...
                    b = random.choice(a)
                    if b==1:
                        webbrowser.open("https://www.youtube.com/watch?v=9XbAJ3z44ac")
                    ...
                    try:
                     temp = data.find("div", class_ = "BNeawe").text
                       ...
                       temp = "N/A" # or handle the error appropriately
                    print("Could not find the element.")
                    print("Could not find the temperature element")
